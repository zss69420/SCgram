...
function SearchBar(props) {
    ...
    //when search context is empty, it reminds user err and input sth
    const [error, setError] = useState("");

    //use search txt + search type to send search request to the server
    ...
    const handleSearch = (value) => {
        ...
        //after warning error, error has to be set to empty
        setError("");
