...
function Home(props) {
    ...
    //step 1: collect search option
    //step 2: send search request to the sever
    //step 3: analyze the response
    //      case 1: success -> pass posts to the gallery
    //      case 2: otherwise, warning
    ...
    const renderPosts = (type) => {
        //case 1: post is empty/ not existed
        //case 2: type == image -> render <PhotoGallery images>
        //case 3: type == videos -> render <videos />
        ...
        if (type === "image") {
            ...
            //step2: check all require fields
